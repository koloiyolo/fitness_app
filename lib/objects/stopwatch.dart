...
class StopWatch {
  ...
  StopWatch(
      ...
      required this.date});String dateToString(DateTime datetime) {
    return (datetime.month==1) ? '${datetime.day} January ${datetime.year}'
  ...
  //toList
  List toList() {
    return [hours, minutes, seconds, deciseconds, date];
  }

  StopWatch fromList(List stopwatch) {
    return StopWatch(
        hours: stopwatch[0],
        minutes: stopwatch[1],
        seconds: stopwatch[2],
